...
const Hero = () => (
  <section className="flex flex-col lg:flex-row min-h-screen overflow-hidden">
    ...
    <div className="flex flex-col w-full lg:w-1/2 items-center justify-center">
      <h1 className="mx-14 md:mx-32 lg:m-0 lg:mr-32 font-island-moments font-normal text-navy text-6xl text-center motion-safe:animate-fade-up motion-reduce:animate-none">
        Varnan is where stories find their voice and form
      </h1>
      <h2 className="mx-14 md:mx-32 lg:m-0 lg:mr-32 py-10 font-halant font-normal text-primary text-3xl text-center motion-safe:animate-fade-up motion-reduce:animate-none">
        Films . Brands . Art
      </h2>
      <p className="mx-20 mb-16 md:mb-0 md:mx-14 lg:mr-48 font-instrument-sans text-center text-secondary motion-safe:animate-fade-up motion-reduce:animate-none">
