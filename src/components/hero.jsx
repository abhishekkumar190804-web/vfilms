...
const Hero = () => (
  <section className="flex flex-col lg:flex-row min-h-screen overflow-hidden">
    ...
    <div className="flex flex-col w-full lg:w-1/2 items-center justify-center">
      <h1 className="mx-14 md:mx-32 lg:m-0 lg:mr-32 font-[Island_Moments] font-normal text-[#0F3255] text-6xl text-center motion-safe:animate-[fadeUp_1s_ease-out_forwards] motion-reduce:animate-none">
        Varnan is where stories find their voice and form
      </h1>
      <h2 className="mx-14 md:mx-32 lg:m-0 lg:mr-32 py-10 font-[Halant] font-normal text-[#F15D2B] text-3xl text-center motion-safe:animate-[fadeUp_1s_ease-out_forwards] motion-reduce:animate-none">
        Films . Brands . Art
      </h2>
