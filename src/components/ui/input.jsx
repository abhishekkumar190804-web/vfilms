const Input = ({ type, className, ...props }) =>
  ...
  placeholder:text-[#757575] resize-none
  
  focus:outline-none focus-visible:ring-2
   focus-visible:ring-[#F15D2B] focus-visible:border-transparent 
  ...
  motion-safe:transition motion-safe:durtaion-200
   ...
   ${className}`}
    ...
    <input
      type={type}
      className={`bg-white/70 backdrop-blur-xs w-full py-2.5 px-3 rounded-xs 
      placeholder:text-[#757575] focus:outline-none
      focus-visible:ring-2 focus-visible:ring-[#F15D2B]
